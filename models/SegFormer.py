...
# logging.set_verbosity_error()  # For do not show the warnings about initialized weights such as "Some weights of ~"
...
class lt_segformerb0(L.LightningModule):
    ...
    def on_train_epoch_end(self):
        mIoU = iou_calculation(self.train_intersections, self.train_unions)
    ...
    def on_validation_epoch_end(self):
        ...
        mIoU = iou_calculation(self.val_intersections, self.val_unions)
